...
<div id="topBarLink"
	class="outsidecontent<?php !$topRegion ? print " withoutTopRegion": print ""; ?>">
...
<div
	class="container_12 <?php print $layout_width; ?>" id="totalContainer">
	<?php if($topRegion): ?>
	<!--start top section-->
	...
	<div id="pageBorder" <?php print $noborder; ?>>
		...
		<?php print ($usebanner == 0) ? 'class="unlimited"' : ""; ?>>
        ...
        */?>
			...
			<div id="innerContent">
				...
				<div class="<?php print marinelli_w_c($layoutType); ?>"
					id="sidebarWrapper">
					<!--start oversidebars-->
